...
export default function Index() {
    ...
    return (
        <div
            className={
                "w-[100vw] max-w-[180rem] h-full absolute top-0 right-0 bottom-0 left-0 z-[2]" +
                " transition-opacity duration-100"
            }
        >
            <div
                className={
                    "w-full h-full absolute top-0 left-0 bg-index bg-center bg-cover bg-no-repeat" +
            ...
            <video
                ...
                style={{
                    height: "calc(100vh + (100vh * 2.35 / 16 * 9 - 100vh) * 1.2)",
                    objectPosition: "50% 0%",
            ...
            <div
                className={
                    "w-[52.5rem] portrait:w-[18.75rem] h-[60.75rem] portrait:h-[12rem] absolute left-0 bottom-0 bg-mask-block portrait:bg-mask-block-m bg-[auto_110%] portrait:bg-[auto_100%] bg-[100%_0] transition-opacity duration-[.6s] ease-linear " +
                    (active ? "delay-[2s] opacity-[.78]" : "opacity-0")
                }
            />
            <div
                className={
                    "w-[52.5rem] portrait:w-[5.75rem] h-[60.75rem] portrait:h-[12rem] absolute left-full bottom-0 bg-mask-block portrait:bg-mask-block-m bg-[auto_110%] portrait:bg-[auto_100%] bg-no-repeat translate-x-[-14.75rem] portrait:translate-x-[-3.75rem] transition-opacity duration-[.6s] ease-linear " +
            ...
            <div
                className={
                    "absolute left-[4.5rem] portrait:left-[2rem] bottom-[2.75rem] portrait:bottom-[3rem]" +
                    " transition-transform duration-1000"
                }
            />
            <div
                className={
                    "absolute left-[4.5rem] portrait:left-[2rem] bottom-[2.75rem] portrait:bottom-[3rem] transition-transform duration-1000 " +
            ...
            >
                <div className={"flex"}>
                    <div
                        className={
                            "leading-[.75] text-[5.5rem] portrait:text-[2.375rem] font-n15eUltraBold" +
                            " mr-[2rem] portrait:mr-[1rem]"
                        }
                    >
                        {title ?? ""}
                    </div>
                ...
                <div className="w-[7.875rem] portrait:w-[7.25rem] mt-[2.5rem] portrait:mt-[9.375rem]">
                    {copyright}
                </div>
            </div>
            ...
            <div
                className={
                    "w-[10.5rem] portrait:w-[5.75rem] absolute" +
