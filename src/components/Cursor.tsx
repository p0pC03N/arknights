const getElement = (selector: string, context: HTMLElement): HTMLElement | null => {
...
class Cursor {
  ...
  constructor() {
    ...
    this.outer = getElement('#cursor-outer', node).style;  // 修复此处
    this.outer.top = '-100%';
    this.effecter = getElement('#cursor-effect', node).style;  // 修复此处
    this.effecter.transform = 'translate(-50%, -50%) scale(0)';
    this.effecter.opacity = '1';
